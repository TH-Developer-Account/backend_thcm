...
export type AccessTokenMinAggregateOutputType = {
  id: string | null
  subjectType: $Enums.AccessTokenSubjectType | null
...
export type AccessTokenGroupByOutputType = {
  id: string
  subjectType: $Enums.AccessTokenSubjectType
  subjectId: string
  token: string
  used: boolean
  purpose: string
...
export type GetAccessTokenGroupByPayload<T extends AccessTokenGroupByArgs> = Prisma.PrismaPromise<
  Array<
...
export type AccessTokenWhereInput = {
  ...
  subjectType?: Prisma.EnumAccessTokenSubjectTypeFilter<"AccessToken"> | $Enums.AccessTokenSubjectType
  subjectId?: Prisma.StringFilter<"AccessToken"> | string
  token?: Prisma.StringFilter<"AccessToken"> | string
  used?: Prisma.BoolFilter<"AccessToken"> | boolean
  purpose?: Prisma.StringFilter<"AccessToken"> | string
  usedAt?: Prisma.DateTimeNullableFilter<"AccessToken"> | Date | string | null
...
export type AccessTokenScalarWhereWithAggregatesInput = {
  ...
  subjectType?: Prisma.EnumAccessTokenSubjectTypeWithAggregatesFilter<"AccessToken"> | $Enums.AccessTokenSubjectType
  subjectId?: Prisma.StringWithAggregatesFilter<"AccessToken"> | string
  token?: Prisma.StringWithAggregatesFilter<"AccessToken"> | string
  used?: Prisma.BoolWithAggregatesFilter<"AccessToken"> | boolean
  purpose?: Prisma.StringWithAggregatesFilter<"AccessToken"> | string
  usedAt?: Prisma.DateTimeNullableWithAggregatesFilter<"AccessToken"> | Date | string | null
  created_at?: Prisma.DateTimeWithAggregatesFilter<"AccessToken"> | Date | string
}
...
export type AccessTokenUpdateInput = {
  ...
  subjectType?: Prisma.EnumAccessTokenSubjectTypeFieldUpdateOperationsInput | $Enums.AccessTokenSubjectType
...
export type EnumAccessTokenSubjectTypeFieldUpdateOperationsInput = {
  set?: $Enums.AccessTokenSubjectType
}
...
export type AccessTokenOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "subjectType" | "subjectId" | "token" | "used" | "purpose" | "usedAt" | "created_at", ExtArgs["result"]["accessToken"]>
...
export interface AccessTokenFieldRefs {
  ...
  readonly subjectType: Prisma.FieldRef<"AccessToken", 'AccessTokenSubjectType'>
  readonly subjectId: Prisma.FieldRef<"AccessToken", 'String'>
  readonly token: Prisma.FieldRef<"AccessToken", 'String'>
  readonly used: Prisma.FieldRef<"AccessToken", 'Boolean'>
  readonly purpose: Prisma.FieldRef<"AccessToken", 'String'>
  readonly usedAt: Prisma.FieldRef<"AccessToken", 'DateTime'>
  readonly created_at: Prisma.FieldRef<"AccessToken", 'DateTime'>
}
